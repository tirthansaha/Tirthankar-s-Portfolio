        ...
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:h-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 border-2 border-[#b2b2b2] rounded-xl"> {/* form border */}
              <h1 className="text-4xl font-semibold text-accent">Let&rsquo;s Work Together</h1>
              {/* input */}
              ...
              <div className="flex-1 flex items-center justify-center ">
                ...
                <Button size="md" className="min-w-30 max-w-40">
                  <a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJlJVXVjfGQfkfVrrtQXshLkxwZLsCPfpxlFJhgpNqTtQgQGFKpGdVXfQhWRgbHkMcLNlBq">Email Directly</a>
                </Button>
              </div>
            </form>
          </div>
